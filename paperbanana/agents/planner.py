...
class PlannerAgent(BaseAgent):
    ...
    async def run(
        ...
        # Inject style guidelines into planner prompt (merged Planner+Stylist)
        if guidelines:
            prompt += (
                "\n\n## Style Guidelines\n\n"
                "Apply these aesthetic guidelines to your description. "
                "Incorporate color palettes, typography, and layout advice directly "
                "into your detailed description.\n\n"
                f"{guidelines}\n"
            )
